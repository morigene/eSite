...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	...
	"_fnConstruct": function ( oInit )
	{
		...
		/* Sanity checking */
		if ( typeof this.s.dt.oInstance.fneSite 2Check != 'function' ||
		     this.s.dt.oInstance.fneSite 2Check( '1.8.0' ) !== true )
		{
			alert( "FixedColumns "+FixedColumns.eSite 2+" required DataTables 1.8.0 or later. "+
...
/**
 * FixedColumns eSite 2
 *  @name      FixedColumns.eSite 2
 *  @type      String
 *  @default   See code
 *  @static
 */
FixedColumns.eSite 2 = "3.0.4";
